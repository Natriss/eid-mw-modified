...
using Be.Belgium.Net.Internal.Delegates;
...
namespace Be.Belgium.Net.Internal.Wrapper
{
	...
	public class Pkcs11Module
	{
		...
		{
			C_Initialize proc = (C_Initialize)DelegateUtil.GetDelegate(hLib, typeof(C_Initialize));
		...
		{
			C_Finalize proc = (C_Finalize)DelegateUtil.GetDelegate(hLib, typeof(C_Finalize));
			checkCKR(proc(IntPtr.Zero));
		}
		...
		{
			C_GetInfo proc = (C_GetInfo)DelegateUtil.GetDelegate(hLib, typeof(C_GetInfo));
		...
		public uint[] GetSlotList(bool tokenPresent)
		{
			...
			C_GetSlotList proc = (C_GetSlotList)DelegateUtil.GetDelegate(hLib, typeof(C_GetSlotList));
		...
		public CK_SLOT_INFO GetSlotInfo(uint slotID)
		{
			...
			C_GetSlotInfo proc = (C_GetSlotInfo)DelegateUtil.GetDelegate(hLib, typeof(C_GetSlotInfo));
		...
		public CK_TOKEN_INFO GetTokenInfo(uint slotID)
		{
			...
			C_GetTokenInfo proc = (C_GetTokenInfo)DelegateUtil.GetDelegate(hLib, typeof(C_GetTokenInfo));
		...
		public uint WaitForSlotEvent(bool DO_NOT_BLOCK)
		{
			...
			C_WaitForSlotEvent proc = (C_WaitForSlotEvent)DelegateUtil.GetDelegate(hLib, typeof(C_WaitForSlotEvent));
		...
		public CKM[] GetMechanismList(uint slotId)
		{
			...
			C_GetMechanismList proc = (C_GetMechanismList)DelegateUtil.GetDelegate(hLib, typeof(C_GetMechanismList));
		...
		public CK_MECHANISM_INFO GetMechanismInfo(uint slotId, CKM mechanism)
		{
			...
			C_GetMechanismInfo proc = (C_GetMechanismInfo)DelegateUtil.GetDelegate(hLib, typeof(C_GetMechanismInfo));
		...
		public void InitToken(uint slotId, string pin, string label)
		{
			...
			C_InitToken proc = (C_InitToken)DelegateUtil.GetDelegate(hLib, typeof(C_InitToken));
		...
		public void InitPIN(uint hSession, string pin)
		{
			...
			C_InitPIN proc = (C_InitPIN)DelegateUtil.GetDelegate(hLib, typeof(C_InitPIN));
		...
		public void SetPIN(uint hSession, string oldPin, string newPin)
		{
			...
			C_SetPIN proc = (C_SetPIN)DelegateUtil.GetDelegate(hLib, typeof(C_SetPIN));
		...
		public uint OpenSession(uint slotId, uint applicationId, bool readOnly)
		{
			...
			C_OpenSession proc = (C_OpenSession)DelegateUtil.GetDelegate(hLib, typeof(C_OpenSession));
		...
		public void CloseSession(uint hSession)
		{
			...
			C_CloseSession proc = (C_CloseSession)DelegateUtil.GetDelegate(hLib, typeof(C_CloseSession));
...
#endif
			C_CloseAllSessions proc = (C_CloseAllSessions)DelegateUtil.GetDelegate(hLib, typeof(C_CloseAllSessions));
		...
		public CK_SESSION_INFO GetSessionInfo(uint hSession)
		{
			...
			C_GetSessionInfo proc = (C_GetSessionInfo)DelegateUtil.GetDelegate(hLib, typeof(C_GetSessionInfo));
		...
		public byte[] GetOperationState(uint hSession)
		{
			...
			C_GetOperationState proc = (C_GetOperationState)DelegateUtil.GetDelegate(hLib, typeof(C_GetOperationState));
		...
		public void SetOperationState(uint hSession, byte[] opState, uint hEncryptionKey, uint hAuthenticationKey)
		{
			...
			C_SetOperationState proc = (C_SetOperationState)DelegateUtil.GetDelegate(hLib, typeof(C_SetOperationState));
		...
		public void Login(uint hSession, CKU userType, string pin)
		{
			...
			C_Login proc = (C_Login)DelegateUtil.GetDelegate(hLib, typeof(C_Login));
		...
		public void Logout(uint hSession)
		{
			...
			C_Logout proc = (C_Logout)DelegateUtil.GetDelegate(hLib, typeof(C_Logout));
		...
		public uint CreateObject(uint hSession, CK_ATTRIBUTE[] template)
		{
			...
			C_CreateObject proc = (C_CreateObject)DelegateUtil.GetDelegate(hLib, typeof(C_CreateObject));
		...
		public void DestroyObject(uint hSession, uint hObj)
		{
			...
			C_DestroyObject proc = (C_DestroyObject)DelegateUtil.GetDelegate(hLib, typeof(C_DestroyObject));
		...
		public uint GetObjectSize(uint hSession, uint hObj)
		{
			...
			C_GetObjectSize proc = (C_GetObjectSize)DelegateUtil.GetDelegate(hLib, typeof(C_GetObjectSize));
		...
		public CK_ATTRIBUTE[] GetAttributeValue(uint hSession, uint hObj, CK_ATTRIBUTE[] template)
		{
			...
			C_GetAttributeValue proc = (C_GetAttributeValue)DelegateUtil.GetDelegate(hLib, typeof(C_GetAttributeValue));
		...
		public void SetAttributeValue(uint hSession, uint hObj, CK_ATTRIBUTE[] pTemplate)
		{
			...
			C_SetAttributeValue proc = (C_SetAttributeValue)DelegateUtil.GetDelegate(hLib, typeof(C_SetAttributeValue));
		...
		public void FindObjectsInit(uint hSession, CK_ATTRIBUTE[] pTemplate)
		{
			...
			C_FindObjectsInit proc = (C_FindObjectsInit)DelegateUtil.GetDelegate(hLib, typeof(C_FindObjectsInit));
		...
		public uint[] FindObjects(uint hSession, uint maxCount)
		{
			...
			C_FindObjects proc = (C_FindObjects)DelegateUtil.GetDelegate(hLib, typeof(C_FindObjects));
			...
			{/*if the count of the objects is less then maxcount then handle it */
		...
		public void FindObjectsFinal(uint hSession)
		{
			...
			C_FindObjectsFinal proc = (C_FindObjectsFinal)DelegateUtil.GetDelegate(hLib, typeof(C_FindObjectsFinal));
		...
		public void EncryptInit(uint hSession, CK_MECHANISM pMechanism, uint hKey)
		{
			...
			C_EncryptInit proc = (C_EncryptInit)DelegateUtil.GetDelegate(hLib, typeof(C_EncryptInit));
		...
		public byte[] Encrypt(uint hSession, byte[] pData)
		{
			...
			C_Encrypt proc = (C_Encrypt)DelegateUtil.GetDelegate(hLib, typeof(C_Encrypt));
		...
		{
			C_EncryptUpdate proc = (C_EncryptUpdate)DelegateUtil.GetDelegate(hLib, typeof(C_EncryptUpdate));
		...
		public byte[] EncryptFinal(uint hSession)
		{
			...
			C_EncryptFinal proc = (C_EncryptFinal)DelegateUtil.GetDelegate(hLib, typeof(C_EncryptFinal));
		...
		public void DecryptInit(uint hSession, CK_MECHANISM pMechanism, uint hKey)
		{
			...
			C_DecryptInit proc = (C_DecryptInit)DelegateUtil.GetDelegate(hLib, typeof(C_DecryptInit));
		...
		public byte[] Decrypt(uint hSession, byte[] pEncryptedData)
		{
			...
			C_Decrypt proc = (C_Decrypt)DelegateUtil.GetDelegate(hLib, typeof(C_Decrypt));
		...
		public byte[] DecryptUpdate(uint hSession, byte[] pEncryptedPart)
		{
			...
			C_DecryptUpdate proc = (C_DecryptUpdate)DelegateUtil.GetDelegate(hLib, typeof(C_DecryptUpdate));
		...
		public byte[] DecryptFinal(uint hSession)
		{
			...
			C_DecryptFinal proc = (C_DecryptFinal)DelegateUtil.GetDelegate(hLib, typeof(C_DecryptFinal));
		...
		public void DigestInit(uint hSession, CK_MECHANISM pMechanism)
		{
			...
			C_DigestInit proc = (C_DigestInit)DelegateUtil.GetDelegate(hLib, typeof(C_DigestInit));
		...
		public byte[] Digest(uint hSession, byte[] pData)
		{
			...
			C_Digest proc = (C_Digest)DelegateUtil.GetDelegate(hLib, typeof(C_Digest));
		...
		public void DigestUpdate(uint hSession, byte[] pPart)
		{
			...
			C_DigestUpdate proc = (C_DigestUpdate)DelegateUtil.GetDelegate(hLib, typeof(C_DigestUpdate));
		...
		public void DigestKey(uint hSession, uint hKey)
		{
			...
			C_DigestKey proc = (C_DigestKey)DelegateUtil.GetDelegate(hLib, typeof(C_DigestKey));
		...
		public byte[] DigestFinal(uint hSession)
		{
			...
			C_DigestFinal proc = (C_DigestFinal)DelegateUtil.GetDelegate(hLib, typeof(C_DigestFinal));
		...
		{
			C_SignInit proc = (C_SignInit)DelegateUtil.GetDelegate(hLib, typeof(C_SignInit));
		...
		public byte[] Sign(uint hSession, byte[] pData)
		{
			...
			C_Sign proc = (C_Sign)DelegateUtil.GetDelegate(hLib, typeof(C_Sign));
		...
		public void SignUpdate(uint hSession, byte[] pPart)
		{
			...
			C_SignUpdate proc = (C_SignUpdate)DelegateUtil.GetDelegate(hLib, typeof(C_SignUpdate));
		...
		public byte[] SignFinal(uint hSession)
		{
			...
			C_SignFinal proc = (C_SignFinal)DelegateUtil.GetDelegate(hLib, typeof(C_SignFinal));
		...
		{
			C_VerifyInit proc = (C_VerifyInit)DelegateUtil.GetDelegate(hLib, typeof(C_VerifyInit));
		...
		public void Verify(uint hSession, byte[] pData, byte[] signature)
		{
			...
			C_Verify proc = (C_Verify)DelegateUtil.GetDelegate(hLib, typeof(C_Verify));
		...
		public void VerifyUpdate(uint hSession, byte[] pPart)
		{
			...
			C_VerifyUpdate proc = (C_VerifyUpdate)DelegateUtil.GetDelegate(hLib, typeof(C_VerifyUpdate));
		...
		public void VerifyFinal(uint hSession, byte[] signature)
		{
			...
			C_VerifyFinal proc = (C_VerifyFinal)DelegateUtil.GetDelegate(hLib, typeof(C_VerifyFinal));
		...
		{
			C_GenerateKey proc = (C_GenerateKey)DelegateUtil.GetDelegate(hLib, typeof(C_GenerateKey));
			uint hKey = 0;
		...
		{
			C_GenerateKeyPair proc = (C_GenerateKeyPair)DelegateUtil.GetDelegate(hLib, typeof(C_GenerateKeyPair));
